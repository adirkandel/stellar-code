import { Calendar, Mail, MessageSquare, Send, User } from "lucide-react";
...
const ContactSection = () => {
	...
	return (
		// biome-ignore lint/correctness/useUniqueElementIds: stable #contact anchor for in-page nav
		<section
			id="contact"
			className="py-24 bg-gradient-galaxy relative overflow-hidden"
		>
			{/* Orbital rings */}
				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="text-center mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							Tell us about your vision or the challenges you're facing - we'll
							figure out how our team can help.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-12 items-start">
						...
						<div className="space-y-8">
							<div className="bg-gradient-card backdrop-blur-sm border border-primary/20 rounded-xl p-6 relative overflow-hidden">
								...
								<div className="relative z-10">
									<div className="flex items-center gap-4 mb-4">
										...
										<div>
											<h4 className="font-semibold text-stellar-white">
												Schedule a Call
											</h4>
							...
							<div className="space-y-6">
								<div>
									<h4 className="font-semibold text-stellar-white mb-4">
										What Happens Next?
									</h4>
									<div className="space-y-4">
										...
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-muted-foreground text-sm">
													Kick off with your dedicated development team
												</p>
											</div>
										</div>
									</div>
