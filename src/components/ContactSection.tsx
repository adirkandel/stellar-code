...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Note: In TanStack Start, this should be moved to a server function
    ...
    try {
      ...
      alert("Error sending message. Please try again or contact us directly at akandel@stellar-code.dev");
    } finally {
