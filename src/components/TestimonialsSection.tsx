...
const TestimonialsSection = () => {
  ...
  const logSlidesInView = useCallback((api: CarouselApi) => {
    ...
    if (currentSlideIndex >= 0) {
      api.slideNodes().forEach((node, nodeIdx) => {
                  ...
                  >
                    ...
                    <div className="absolute right-4 bottom-4 opacity-10">
                      <img
                        ...
                        className={`h-28 w-auto object-contain ${(testimonial as any).logoClassName || ""}`}
                      />
                    </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center gap-4">
                        <Avatar className="w-12 h-12 border-2 border-primary/40">
                          <AvatarImage src={testimonial.avatarImage || undefined} alt={`${testimonial.name} avatar`} />
