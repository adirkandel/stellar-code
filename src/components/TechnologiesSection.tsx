                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        width: `${isMobile ? tech.mobileSize : tech.size}px`,
                        height: `${isMobile ? tech.mobileSize : tech.size}px`,
                      }}
                    >
                      {/* Bubble background */}
                      ...
                      <div className="absolute inset-0 flex items-center justify-center p-4">
                        <img
                          ...
                          style={{
                            width: `${(isMobile ? tech.mobileSize : tech.size) * 0.4}px`,
                            height: `${(isMobile ? tech.mobileSize : tech.size) * 0.4}px`,
                          }}
                        />
                      </div>
