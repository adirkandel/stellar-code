...
const TechnologiesSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Top gradient blend */}
      <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#080311] to-transparent z-10"></div>
      
      {/* Bottom gradient blend */}
      <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#080311] to-transparent z-10"></div>
