            ...
            {caseStudies.map((study, index) => (
              <CarouselItem key={index} className="pl-6 basis-full md:basis-2/3 lg:basis-1/2">
                <div className="relative pb-14 pt-8 transition-all duration-500 ease-out [&:not(.embla-slide-snapped)]:scale-75 [&:not(.embla-slide-snapped)]:opacity-50">
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 -translate-y-18 w-9/10 bg-stellar-white/95 backdrop-blur-sm rounded-lg p-6 border border-primary/10 shadow-lg z-20">
